...
<html lang="en">
  <head>
    ...
    <title>Outlet Malang | Nasi Kulit Syuurga</title>
                            ...
                            <li>
                              <div class="media">
                                <div class="media-left">
                                  <a href="https://goo.gl/maps/XqWWBM1gYhiNa48QA">
                                    <img class="media-object" src="assets/img/chef/google maps.jpg" alt="img">
                                  </a>
                                </div>
                                <div class="media-body">
                                  <h4 class="media-heading"><a href="#"><b>MALANG</b></a></h4>
                                  <a href="https://gofood.link/u/nJLMmZ">
                                  ...
                                  <a href="#">
                                    ...
                                    <p>Senin - Minggu 10.00 - 21.00 WIB</h6></p>
                                </div>
                              </div>
                            </li>
                          </ul>   
