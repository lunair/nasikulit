...
<html lang="en">
  <head>
    ...
    <title>Outlet Bandung | Nasi Kulit Syuurga</title>
                            ...
                            <li>
                              <div class="media">
                                <div class="media-left">
                                  <a href="https://goo.gl/maps/CkygwyEmxapAL3eWA">
                                    <img class="media-object" src="assets/img/chef/google maps.jpg" alt="img">
                                  </a>
                                </div>
                                <div class="media-body">
                                  <h4 class="media-heading"><a href="#"><b>BANDUNG</b></a></h4>
                                  <a href="https://gofood.link/u/kj51j">
                                  ...
                                  <a href="#">
                                    ...
                                    <p>Senin - Minggu 11.00 - 20.30 WIB</h6></p>
                                </div>
                              </div>
                            </li>
                          </ul>   
